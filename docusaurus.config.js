...
const description = "This is John Reilly's travel(ish) blog.";
const sameAs = [
...
const siteStructuredData = {
    ...
    '@graph': [
        ...
        },
        {
            ...
            description: 'John is an Open Source Software Engineer working on TypeScript, Azure, React, Node.js, .NET and more. As well as writing code, John is a speaker at meetups, one of the founders of the TS Congress conference, and the author of the history of Definitely Typed, which he worked on in the early days of TypeScript.',
        ...
        [
            'classic',
            {
                ...
                blog: {
                    ...
                    editUrl: 'https://github.com/johnnyreilly/reillys-on-tour/tree/main/edit/',
